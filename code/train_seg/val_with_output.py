...
def main():
    ...
    output_data_path = 'output' if args.output_data_path == None else args.output_data_path
    class_name_list = args.class_name.rstrip().split(',')
    dataset_name = config['dataset'] if args.dataset_name == None else args.dataset_name
