...
new_settings = {
    ...
    "resnet50": {
        'timm': "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rsb-weights/resnet50_a1_0-14fe96d1.pth", # noqa
        ...
        'histology': "/public/tmp/lz_models/model_gen/hist/resnet50/teacher_checkpoint.pth"
    },
    "resnext50_32x4d": {
...
for model_name, sources in new_settings.items():
    ...
    for source_name, source_url in sources.items():
        if source_name == 'histology':
            pretrained_settings[model_name][source_name] = {
                "url": source_url,
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.6949, 0.5214, 0.6893],
                "std": [0.1871, 0.2058, 0.1526],
                "num_classes": 1000,
            }
        else:
            pretrained_settings[model_name][source_name] = {
