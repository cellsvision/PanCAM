...
class DeepLabV3PlusMultiScale(SegmentationModelMultiScale):
    ...
    def __init__(
        ...
        self.low_scale_encoder = get_encoder(
            encoder_name,
            in_channels=in_channels,
            depth=encoder_depth,
            weights=encoder_weights,
        ...
        self.high_scale_encoder = get_encoder(
            encoder_name,
            in_channels=in_channels,
            depth=encoder_depth,
            weights=encoder_weights,
        ...
        out_channels = self.low_scale_encoder.out_channels + self.low_scale_encoder.out_channels
        print(out_channels)
