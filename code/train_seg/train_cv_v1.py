...
from dataset import CSVBSDatasetV1, CSVBSDatasetV2
...
def parse_args():
    ...
    parser.add_argument('--hard_sample_csv', default=None)
...
def main():
    ...
    hard_sample_list = list(pd.read_csv(config['hard_sample_csv'])['filename'])
...
####################################################################################
    ...
    train_dataset = CSVBSDatasetV2(
                                    ...
                                    hard_sample_data_list = hard_sample_list,
